...
*/}}
{{- define "golang-repository-template.name" -}}
...
*/}}
{{- define "golang-repository-template.fullname" -}}
...
*/}}
{{- define "golang-repository-template.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "golang-repository-template.resourceName" -}}
{{- $fullname := include "golang-repository-template.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "golang-repository-template.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "golang-repository-template.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
